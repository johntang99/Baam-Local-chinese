...
export default async function GuideDetailPage({ params }: Props) {
  ...
  const vertical = verticalConfig[article.content_vertical] || { label: '指南', className: 'badge-gray' };
        ...
        <div className="lg:flex gap-8">
          ...
          <article className="flex-1 max-w-[var(--content-max)]">
            ...
            <header className="mb-6">
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs text-text-muted">
                ...
                {article.read_time_minutes && (
                  <span>{article.read_time_minutes}分钟阅读</span>
                )}
                {article.region_id && (
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {biz.avg_rating && (
                            <div className="flex items-center gap-1 mt-0.5">
                              ...
                              <span className="text-xs text-text-muted">{biz.avg_rating} ({biz.review_count || 0}评价)</span>
                            </div>
                          )}
            ...
            <section className="lead-capture mb-8">
              <h2 className="text-lg font-bold mb-2">需要专业帮助？</h2>
                  ...
                  {relatedNews.map((news) => (
                    <Link key={news.id} href={`/news/${news.slug}`} className="card p-4 block">
                      <div className="flex items-center gap-1.5 mb-2">
                        <span className="badge badge-gray text-xs">新闻</span>
                        {news.published_at && (
