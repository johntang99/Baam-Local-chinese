  ...
  return (
    <main>
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl fw-bold text-text-primary mb-2">纽约州房产税查询</h1>
      ...
      <Card className="r-xl p-6 mb-8">
        ...
        <h2 className="text-lg fw-bold text-text-primary mt-0">纽约房产税怎么算？</h2>
        ...
        <h3 className="text-base fw-bold text-text-primary">四种房产税等级（Tax Class）</h3>
        <div className="not-prose overflow-x-auto mb-4">
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-bg-page">
                <th className="text-left px-3 py-2 border border-border fw-semibold">等级</th>
                <th className="text-left px-3 py-2 border border-border fw-semibold">适用类型</th>
                <th className="text-left px-3 py-2 border border-border fw-semibold">2025/26税率</th>
              </tr>
            </thead>
            <tbody>
              <tr><td className="px-3 py-2 border border-border fw-medium">Class 1</td><td className="px-3 py-2 border border-border">1-3家庭住宅</td><td className="px-3 py-2 border border-border">20.309%</td></tr>
              <tr><td className="px-3 py-2 border border-border fw-medium">Class 2</td><td className="px-3 py-2 border border-border">公寓楼（含Co-op、Condo）</td><td className="px-3 py-2 border border-border">12.267%</td></tr>
              <tr><td className="px-3 py-2 border border-border fw-medium">Class 3</td><td className="px-3 py-2 border border-border">公用事业设施</td><td className="px-3 py-2 border border-border">12.826%</td></tr>
              <tr><td className="px-3 py-2 border border-border fw-medium">Class 4</td><td className="px-3 py-2 border border-border">商业地产</td><td className="px-3 py-2 border border-border">10.646%</td></tr>
            </tbody>
          </table>
        </div>

        <h3 className="text-base fw-bold text-text-primary">什么是STAR减免？</h3>
        ...
        <h3 className="text-base fw-bold text-text-primary">评估值太高怎么申诉？</h3>
      ...
      <section className="mb-8">
        ...
        <div className="grid sm:grid-cols-3 gap-3">
          <Link href="/businesses" className="block">
            ...
            <h3 className="text-sm fw-bold text-text-primary group-hover:text-primary mb-1">找地产经纪</h3>
            <p className="text-xs text-text-muted">浏览Baam认证地产经纪</p>
            </Card>
          </Link>
          <Link href="/ask" className="block">
            ...
            <p className="text-xs text-text-muted">&ldquo;法拉盛房产税一般多少？&rdquo;</p>
            </Card>
          </Link>
          <Link href="/services/vehicle-violations" className="block">
            <Card className="r-xl p-4 hover:border-primary/30 hover:elev-sm transition group text-center">
            <div className="text-2xl mb-2">🚗</div>
            <h3 className="text-sm fw-bold text-text-primary group-hover:text-primary mb-1">停车罚单查询</h3>
            <p className="text-xs text-text-muted">查看车辆违规记录</p>
            </Card>
          </Link>
        </div>
      </section>
