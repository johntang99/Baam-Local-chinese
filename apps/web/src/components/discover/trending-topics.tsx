    ...
    <div className="flex gap-2 overflow-x-auto scrollbar-hide -mx-4 px-4 pb-1">
      {topics.map((topic, i) => (
        <Link
          ...
          className={`chip ${topic.is_featured ? 'active' : ''}`}
        >
          {topic.is_featured && i < 3 && (
        ...
        {topics.slice(0, 5).map((topic, i) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400">{formatViews(topic.post_count || 0)} 浏览</p>
            </div>
          </Link>
        ))}
      </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  {formatViews(post.like_count || 0)} 赞 · {formatViews(post.save_count || 0)} 收藏
                </p>
              </div>
            </Link>
          );
