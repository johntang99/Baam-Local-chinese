  ...
  return (
    ...
    >
      <div className="relative w-[90vw] max-w-[1100px] h-[90vh] max-h-[720px] bg-white rounded-2xl overflow-hidden flex shadow-[0_24px_80px_rgba(0,0,0,0.3)]">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 w-9 h-9 rounded-full bg-black/5 hover:bg-black/10 flex items-center justify-center text-gray-500 hover:text-gray-800 transition"
        >
