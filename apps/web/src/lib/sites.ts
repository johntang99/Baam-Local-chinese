...
const STATIC_DOMAIN_MAP: Record<string, string> = {
  // Production domains
  'chinese-newyork.com': 'ny-zh',
  'www.chinese-newyork.com': 'ny-zh',
  // Staging / dev domains
  'baam-local-life-web.vercel.app': 'ny-zh',
  'localhost': 'ny-zh',
  // Future sites
  // 'middletown-local.com': 'oc-en',
  // 'oc.baam.us': 'oc-en',
};
  ...
  return [
    {
      ...
      nameZh: '纽约中文站',
      locale: 'zh',
      domain: 'chinese-newyork.com',
      description: '面向纽约华人社区',
      status: 'active',
      isDefault: true,
      regionIds: [],
    },
    {
      ...
      locale: 'en',
      domain: 'oc.baam.us',
      description: 'Local portal for Orange County area',
      status: 'planned',
      isDefault: false,
      regionIds: [],
    },
